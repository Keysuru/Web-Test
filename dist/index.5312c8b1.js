!function() {
        ...
        t.exports = {
            polyfill: function() {
                ...
                if (!("scrollBehavior" in e.documentElement.style) || !0 === t.__forceSmoothScrollPolyfill__) {
                    ...
                    }, o = t.performance && t.performance.now ? t.performance.now.bind(t.performance) : Date.now, l = (i = t.navigator.userAgent, new RegExp([
                        "MSIE ",
                        "Trident/",
                        "Edge/"
                    ].join("|")).test(i) ? 1 : 0);
            ...
            },
            {
                ...
                value: function() {
                    ...
                    Object.entries(this.els).forEach(function(e) {
                        var i = f(e, 2), s = i[0], n = i[1], o = n.targetEl.getBoundingClientRect().top + t.instance.scroll.y, l = o + n.targetEl.offsetHeight, r = t.getRelativeOffset(n.offset);
    ...
    }(g)), k = Object.getOwnPropertySymbols, E = Object.prototype.hasOwnProperty, T = Object.prototype.propertyIsEnumerable;
    function A(t) {
    ...
    }, j = Object.prototype.toString, B = Object.prototype.hasOwnProperty;
    function _(t, e) {
        return function() {
    ...
    var tt = function(t, e, i, s) {
        ...
        return i(n, [
            ...
            },
            {
                ...
                value: function() {
                    ...
                    this.els = {}, this.parallaxElements = {}, this.el.querySelectorAll("[data-".concat(this.name, "]")).forEach(function(e, i) {
                        ...
                        if (v) {
                            var E = e.getBoundingClientRect(), T = E.top, A = E.left, O = {
                                x: A - n,
                                y: T - s
                            };
            ...
            },
            {
                key: "scrollTo",
                value: function(t) {
                    var e = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, s = parseInt(i.offset) || 0, n = isNaN(parseInt(i.duration)) ? 1e3 : parseInt(i.duration), o = i.easing || [
                        .25,
                        0,
                        .35,
                        1
                    ], l = !!i.disableLerp, r = !!i.callback && i.callback;
                    ...
                    var y = parseFloat(this.instance.delta[this.directionAxis]), g = Math.max(0, Math.min(s, this.instance.limit[this.directionAxis])), b = g - y, w = function(t) {
...
//# sourceMappingURL=index.5312c8b1.js.map
